...
void app::audio::GlitchEngine::TrackerProcessFrame(audio_frame_t &input, size_t n_frames,size_t frame_index)
{
...
size_t app::audio::GlitchEngine::NumberGlitchFrameCandidates()
{
...
void app::audio::GlitchEngine::FreezeEnable(bool enable)
{
    is_freeze_enabled_ = enable;
}
